var app = angular.module('motozio', ['$strap.directives']);

app.directive('apTypeahead', ['$parse',function($parse) {
    ...
    return {
        ...
        link: function(scope, element, attrs, controller)
        {
            ...
            var itemStr =  attrs.apTypeahead.replace(/\s+/g, '');
            ...
            $(element).typeahead({
                source: function ( query, process ) {
                    ...
                    $.get( '/services/v1/solr/search?searchtype=suggest&concepttype=GLOSSEXTENDED_ONTOCHILD_LEV1', { searchtext: query }, function ( data ) {
